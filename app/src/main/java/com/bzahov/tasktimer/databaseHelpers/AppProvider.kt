...
import com.bzahov.tasktimer.contracts.TimingsContract

/**
 *   Provider for TaskTimerApp only that class knows about [AppDatabase].
 * */

private const val TAG = "AppProvider"

const val CONTENT_AUTHORITY = "com.bzahov.tasktimer.provider"
...
class AppProvider : ContentProvider() {
    ...
    private fun buildUriMatcher(): UriMatcher {
        ...
        matcher.addURI(
            CONTENT_AUTHORITY,
            TasksContract.TABLE_NAME, TASKS
        )
        matcher.addURI(
...
//
//        matcher.addURI(CONTENT_AUTHORITY,DurationContract.TABLE_NAME, TASKS)
//        matcher.addURI(CONTENT_AUTHORITY,"${DurationContract.TABLE_NAME}/#", TASKS_ID)
...
//            }
    ...
    override fun insert(uri: Uri, values: ContentValues?): Uri {
        ...
        val recordId: Long
        val returnUri: Uri
        context ?: throw java.lang.NullPointerException()
        when(match) {
            ...
            TASKS -> {
                ...
                } else throw SQLException("FAILED to inset $uri")
            }
            TIMINGS -> {
                val db = AppDatabase.getInstance(context!!).writableDatabase
    ...
    override fun delete(uri: Uri, selection: String?, selectionArgs: Array<out String>?): Int {
        ...
        Log.d(TAG, "EXITING update $uri returning $count")
